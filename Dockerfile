...
RUN apt-get update && apt-get upgrade -y && apt-get install git -y && apt-get autoremove && apt-get clean -y && mkdir -p /var/www \
    ...
    && git clone -b openacs-5-10-compat https://github.com/openacs/xotcl-core.git && git clone -b openacs-5-10-compat https://github.com/openacs/xotcl-request-monitor.git \
    && git clone -b openacs-5-10-compat https://github.com/openacs/ajaxhelper \
    && git clone -b openacs-5-10-compat https://github.com/openacs/richtext-ckeditor4 \
