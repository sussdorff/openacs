...
RUN apt-get update && apt-get upgrade -y && apt-get install git -y && apt-get autoremove && apt-get clean -y && mkdir -p /var/www \
    && git clone -b oacs-5-9 https://github.com/openacs/openacs-core.git && mv openacs-core /var/www/openacs \
    && mkdir -p /var/www/openacs/log \
    && cd /var/www/openacs/packages \
    && git clone -b oacs-5-9 https://github.com/openacs/xotcl-core.git && git clone -b oacs-5-9 https://github.com/openacs/xotcl-request-monitor.git \
    && git clone -b oacs-5-9 https://github.com/openacs/ajaxhelper \
    && git clone -b oacs-5-9 https://github.com/openacs/richtext-ckeditor4 \
